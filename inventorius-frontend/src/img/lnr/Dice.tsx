...
function SvgDice(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} {...props}>
      ...
      <path d="M15.5 19h-12A2.503 2.503 0 011 16.5v-12C1 3.122 2.122 2 3.5 2h12C16.878 2 18 3.122 18 4.5v12c0 1.378-1.122 2.5-2.5 2.5zM3.5 3C2.673 3 2 3.673 2 4.5v12c0 .827.673 1.5 1.5 1.5h12c.827 0 1.5-.673 1.5-1.5v-12c0-.827-.673-1.5-1.5-1.5h-12z" />
    </svg>
  );
}
